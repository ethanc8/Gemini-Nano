...
def SplitVOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    SplitVOptionsStart(builder)

def SplitVOptionsAddNumSplits(builder: flatbuffers.Builder, numSplits: int):
    builder.PrependInt32Slot(0, numSplits, 0)

def AddNumSplits(builder: flatbuffers.Builder, numSplits: int):
    SplitVOptionsAddNumSplits(builder, numSplits)

def SplitVOptionsEnd(builder: flatbuffers.Builder) -> int:
