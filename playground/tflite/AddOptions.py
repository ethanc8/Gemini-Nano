...
def AddOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(2)

def Start(builder: flatbuffers.Builder):
    AddOptionsStart(builder)

def AddOptionsAddFusedActivationFunction(builder: flatbuffers.Builder, fusedActivationFunction: int):
...
def AddOptionsAddPotScaleInt16(builder: flatbuffers.Builder, potScaleInt16: bool):
...
def AddOptionsEnd(builder: flatbuffers.Builder) -> int:
