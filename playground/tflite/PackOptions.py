...
def PackOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(2)

def Start(builder: flatbuffers.Builder):
    PackOptionsStart(builder)

def PackOptionsAddValuesCount(builder: flatbuffers.Builder, valuesCount: int):
    builder.PrependInt32Slot(0, valuesCount, 0)

def AddValuesCount(builder: flatbuffers.Builder, valuesCount: int):
    PackOptionsAddValuesCount(builder, valuesCount)

def PackOptionsAddAxis(builder: flatbuffers.Builder, axis: int):
    builder.PrependInt32Slot(1, axis, 0)

def AddAxis(builder: flatbuffers.Builder, axis: int):
    PackOptionsAddAxis(builder, axis)

def PackOptionsEnd(builder: flatbuffers.Builder) -> int:
