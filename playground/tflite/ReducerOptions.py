...
def ReducerOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    ReducerOptionsStart(builder)

def ReducerOptionsAddKeepDims(builder: flatbuffers.Builder, keepDims: bool):
    builder.PrependBoolSlot(0, keepDims, 0)

def AddKeepDims(builder: flatbuffers.Builder, keepDims: bool):
    ReducerOptionsAddKeepDims(builder, keepDims)

def ReducerOptionsEnd(builder: flatbuffers.Builder) -> int:
