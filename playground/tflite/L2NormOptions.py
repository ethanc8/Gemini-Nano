...
def L2NormOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    L2NormOptionsStart(builder)

def L2NormOptionsAddFusedActivationFunction(builder: flatbuffers.Builder, fusedActivationFunction: int):
...
def L2NormOptionsEnd(builder: flatbuffers.Builder) -> int:
