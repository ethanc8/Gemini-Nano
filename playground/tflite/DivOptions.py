...
def DivOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    DivOptionsStart(builder)

def DivOptionsAddFusedActivationFunction(builder: flatbuffers.Builder, fusedActivationFunction: int):
...
def DivOptionsEnd(builder: flatbuffers.Builder) -> int:
