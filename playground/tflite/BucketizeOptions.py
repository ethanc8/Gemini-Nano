...
def BucketizeOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    BucketizeOptionsStart(builder)

def BucketizeOptionsAddBoundaries(builder: flatbuffers.Builder, boundaries: int):
...
def BucketizeOptionsStartBoundariesVector(builder, numElems: int) -> int:
    return builder.StartVector(4, numElems, 4)

def StartBoundariesVector(builder, numElems: int) -> int:
    return BucketizeOptionsStartBoundariesVector(builder, numElems)

def BucketizeOptionsEnd(builder: flatbuffers.Builder) -> int:
