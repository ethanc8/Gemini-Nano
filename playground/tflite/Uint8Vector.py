...
def Uint8VectorStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    Uint8VectorStart(builder)

def Uint8VectorAddValues(builder: flatbuffers.Builder, values: int):
...
def Uint8VectorStartValuesVector(builder, numElems: int) -> int:
    return builder.StartVector(1, numElems, 1)

def StartValuesVector(builder, numElems: int) -> int:
    return Uint8VectorStartValuesVector(builder, numElems)

def Uint8VectorEnd(builder: flatbuffers.Builder) -> int:
