...
def CallOnceOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    CallOnceOptionsStart(builder)

def CallOnceOptionsAddInitSubgraphIndex(builder: flatbuffers.Builder, initSubgraphIndex: int):
    builder.PrependInt32Slot(0, initSubgraphIndex, 0)

def AddInitSubgraphIndex(builder: flatbuffers.Builder, initSubgraphIndex: int):
    CallOnceOptionsAddInitSubgraphIndex(builder, initSubgraphIndex)

def CallOnceOptionsEnd(builder: flatbuffers.Builder) -> int:
