...
def RNNOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(2)

def Start(builder: flatbuffers.Builder):
    RNNOptionsStart(builder)

def RNNOptionsAddFusedActivationFunction(builder: flatbuffers.Builder, fusedActivationFunction: int):
...
def RNNOptionsAddAsymmetricQuantizeInputs(builder: flatbuffers.Builder, asymmetricQuantizeInputs: bool):
...
def RNNOptionsEnd(builder: flatbuffers.Builder) -> int:
