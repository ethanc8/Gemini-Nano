...
def ShapeOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    ShapeOptionsStart(builder)

def ShapeOptionsAddOutType(builder: flatbuffers.Builder, outType: int):
    builder.PrependInt8Slot(0, outType, 0)

def AddOutType(builder: flatbuffers.Builder, outType: int):
    ShapeOptionsAddOutType(builder, outType)

def ShapeOptionsEnd(builder: flatbuffers.Builder) -> int:
