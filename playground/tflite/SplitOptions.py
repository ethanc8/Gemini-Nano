...
def SplitOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    SplitOptionsStart(builder)

def SplitOptionsAddNumSplits(builder: flatbuffers.Builder, numSplits: int):
...
def SplitOptionsEnd(builder: flatbuffers.Builder) -> int:
