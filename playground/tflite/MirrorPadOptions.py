...
def MirrorPadOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    MirrorPadOptionsStart(builder)

def MirrorPadOptionsAddMode(builder: flatbuffers.Builder, mode: int):
    builder.PrependInt8Slot(0, mode, 0)

def AddMode(builder: flatbuffers.Builder, mode: int):
    MirrorPadOptionsAddMode(builder, mode)

def MirrorPadOptionsEnd(builder: flatbuffers.Builder) -> int:
