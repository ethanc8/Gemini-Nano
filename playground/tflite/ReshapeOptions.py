...
def ReshapeOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    ReshapeOptionsStart(builder)

def ReshapeOptionsAddNewShape(builder: flatbuffers.Builder, newShape: int):
...
def ReshapeOptionsStartNewShapeVector(builder, numElems: int) -> int:
    return builder.StartVector(4, numElems, 4)

def StartNewShapeVector(builder, numElems: int) -> int:
    return ReshapeOptionsStartNewShapeVector(builder, numElems)

def ReshapeOptionsEnd(builder: flatbuffers.Builder) -> int:
