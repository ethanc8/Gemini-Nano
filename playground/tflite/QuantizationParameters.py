...
class QuantizationParameters(object):
    ...
    # QuantizationParameters
    def Details(self) -> Optional[flatbuffers.table.Table]:
...
def QuantizationParametersStart(builder: flatbuffers.Builder):
    builder.StartObject(7)

def Start(builder: flatbuffers.Builder):
    QuantizationParametersStart(builder)

def QuantizationParametersAddMin(builder: flatbuffers.Builder, min: int):
...
def QuantizationParametersStartMinVector(builder, numElems: int) -> int:
    return builder.StartVector(4, numElems, 4)

def StartMinVector(builder, numElems: int) -> int:
    return QuantizationParametersStartMinVector(builder, numElems)

def QuantizationParametersAddMax(builder: flatbuffers.Builder, max: int):
...
def QuantizationParametersStartMaxVector(builder, numElems: int) -> int:
    return builder.StartVector(4, numElems, 4)

def StartMaxVector(builder, numElems: int) -> int:
    return QuantizationParametersStartMaxVector(builder, numElems)

def QuantizationParametersAddScale(builder: flatbuffers.Builder, scale: int):
...
def QuantizationParametersStartScaleVector(builder, numElems: int) -> int:
    return builder.StartVector(4, numElems, 4)

def StartScaleVector(builder, numElems: int) -> int:
    return QuantizationParametersStartScaleVector(builder, numElems)

def QuantizationParametersAddZeroPoint(builder: flatbuffers.Builder, zeroPoint: int):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(zeroPoint), 0)

def AddZeroPoint(builder: flatbuffers.Builder, zeroPoint: int):
    QuantizationParametersAddZeroPoint(builder, zeroPoint)

def QuantizationParametersStartZeroPointVector(builder, numElems: int) -> int:
...
def QuantizationParametersAddDetailsType(builder: flatbuffers.Builder, detailsType: int):
    builder.PrependUint8Slot(4, detailsType, 0)

def AddDetailsType(builder: flatbuffers.Builder, detailsType: int):
    QuantizationParametersAddDetailsType(builder, detailsType)

def QuantizationParametersAddDetails(builder: flatbuffers.Builder, details: int):
    builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(details), 0)

def AddDetails(builder: flatbuffers.Builder, details: int):
    QuantizationParametersAddDetails(builder, details)

def QuantizationParametersAddQuantizedDimension(builder: flatbuffers.Builder, quantizedDimension: int):
    builder.PrependInt32Slot(6, quantizedDimension, 0)

def AddQuantizedDimension(builder: flatbuffers.Builder, quantizedDimension: int):
    QuantizationParametersAddQuantizedDimension(builder, quantizedDimension)

def QuantizationParametersEnd(builder: flatbuffers.Builder) -> int:
