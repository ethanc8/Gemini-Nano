...
def SVDFOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(3)

def Start(builder: flatbuffers.Builder):
    SVDFOptionsStart(builder)

def SVDFOptionsAddRank(builder: flatbuffers.Builder, rank: int):
    builder.PrependInt32Slot(0, rank, 0)

def AddRank(builder: flatbuffers.Builder, rank: int):
    SVDFOptionsAddRank(builder, rank)

def SVDFOptionsAddFusedActivationFunction(builder: flatbuffers.Builder, fusedActivationFunction: int):
...
def SVDFOptionsAddAsymmetricQuantizeInputs(builder: flatbuffers.Builder, asymmetricQuantizeInputs: bool):
...
def SVDFOptionsEnd(builder: flatbuffers.Builder) -> int:
