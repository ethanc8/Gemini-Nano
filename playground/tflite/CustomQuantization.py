...
class CustomQuantization(object):
    ...
    # CustomQuantization
    def CustomIsNone(self) -> bool:
        o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(4))
        return o == 0

def CustomQuantizationStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    CustomQuantizationStart(builder)

def CustomQuantizationAddCustom(builder: flatbuffers.Builder, custom: int):
    builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(custom), 0)

def AddCustom(builder: flatbuffers.Builder, custom: int):
    CustomQuantizationAddCustom(builder, custom)

def CustomQuantizationStartCustomVector(builder, numElems: int) -> int:
    return builder.StartVector(1, numElems, 1)

def StartCustomVector(builder, numElems: int) -> int:
    return CustomQuantizationStartCustomVector(builder, numElems)

def CustomQuantizationEnd(builder: flatbuffers.Builder) -> int:
