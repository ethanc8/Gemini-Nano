...
def SoftmaxOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    SoftmaxOptionsStart(builder)

def SoftmaxOptionsAddBeta(builder: flatbuffers.Builder, beta: float):
...
def SoftmaxOptionsEnd(builder: flatbuffers.Builder) -> int:
