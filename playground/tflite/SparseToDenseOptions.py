...
def SparseToDenseOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    SparseToDenseOptionsStart(builder)

def SparseToDenseOptionsAddValidateIndices(builder: flatbuffers.Builder, validateIndices: bool):
    builder.PrependBoolSlot(0, validateIndices, 0)

def AddValidateIndices(builder: flatbuffers.Builder, validateIndices: bool):
    SparseToDenseOptionsAddValidateIndices(builder, validateIndices)

def SparseToDenseOptionsEnd(builder: flatbuffers.Builder) -> int:
