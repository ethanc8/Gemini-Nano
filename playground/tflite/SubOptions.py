...
def SubOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(2)

def Start(builder: flatbuffers.Builder):
    SubOptionsStart(builder)

def SubOptionsAddFusedActivationFunction(builder: flatbuffers.Builder, fusedActivationFunction: int):
...
def SubOptionsAddPotScaleInt16(builder: flatbuffers.Builder, potScaleInt16: bool):
    builder.PrependBoolSlot(1, potScaleInt16, 1)

def AddPotScaleInt16(builder: flatbuffers.Builder, potScaleInt16: bool):
    SubOptionsAddPotScaleInt16(builder, potScaleInt16)

def SubOptionsEnd(builder: flatbuffers.Builder) -> int:
