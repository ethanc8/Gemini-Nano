...
def Int32VectorStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    Int32VectorStart(builder)

def Int32VectorAddValues(builder: flatbuffers.Builder, values: int):
...
def Int32VectorStartValuesVector(builder, numElems: int) -> int:
    return builder.StartVector(4, numElems, 4)

def StartValuesVector(builder, numElems: int) -> int:
    return Int32VectorStartValuesVector(builder, numElems)

def Int32VectorEnd(builder: flatbuffers.Builder) -> int:
