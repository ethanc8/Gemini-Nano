...
def LeakyReluOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(1)

def Start(builder: flatbuffers.Builder):
    LeakyReluOptionsStart(builder)

def LeakyReluOptionsAddAlpha(builder: flatbuffers.Builder, alpha: float):
...
def LeakyReluOptionsEnd(builder: flatbuffers.Builder) -> int:
