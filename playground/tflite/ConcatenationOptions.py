...
def ConcatenationOptionsStart(builder: flatbuffers.Builder):
    builder.StartObject(2)

def Start(builder: flatbuffers.Builder):
    ConcatenationOptionsStart(builder)

def ConcatenationOptionsAddAxis(builder: flatbuffers.Builder, axis: int):
    builder.PrependInt32Slot(0, axis, 0)

def AddAxis(builder: flatbuffers.Builder, axis: int):
    ConcatenationOptionsAddAxis(builder, axis)

def ConcatenationOptionsAddFusedActivationFunction(builder: flatbuffers.Builder, fusedActivationFunction: int):
...
def ConcatenationOptionsEnd(builder: flatbuffers.Builder) -> int:
